...
const Banner = () => {
  ...
  <div className="card-body">
    ...
    <h1 className="text-4xl font-bold text-black">Navigate Your Tasks Seamlessly with TaskTraverse</h1>
...
<Link to='/login'> <button className="btn bg-blue-500 hover:bg-blue-600 text-white mt-4"> Let's Explore </button> </Link>
